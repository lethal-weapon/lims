...
class AccountAdmin(UserAdmin):
    ...
    list_display = ('campus_id', 'school', 'name', 'is_verified',
                    'is_staff', 'is_admin', 'email', 'last_login')
    ...
    fieldsets = (
        ...
        ('Permissions', {
            'fields': ('is_staff', 'is_admin', 'is_active',
                       'is_delete', 'is_verified')
        }),
        ('Important dates', {
